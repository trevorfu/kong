...
build = {
  ...
  modules = {
    ...
    ["kong.plugins.apirouter.handler"] = "kong/custom_plugins/apirouter/handler.lua",
    ["kong.plugins.apirouter.schema"] = "kong/custom_plugins/apirouter/schema.lua",
    ["kong.plugins.apirouter.redis"] = "kong/custom_plugins/apirouter/redis.lua",
    ["kong.plugins.apirouter.mysql"] = "kong/custom_plugins/apirouter/mysql.lua",
    ["kong.plugins.apirouter.config"] = "kong/custom_plugins/apirouter/config.lua",
